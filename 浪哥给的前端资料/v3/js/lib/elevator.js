/*  elevator.js Date:2015-09-15 18:39:14 */
!function(a) {
    var c = -1;
    var d = -1;
    var e = [];
	...
	var Elevator =function (element, options) {
		    this.el=$(element);
		    this.options= $.extend({}, $.fn.elevator.defaults, options);
            var b = this;			
            var c = b.options;
            var d = b.el;
