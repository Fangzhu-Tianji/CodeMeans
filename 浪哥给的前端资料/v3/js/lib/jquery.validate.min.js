...
!function(a) {
    ...
    a.extend(a.fn, {validate: function(b) {
        ...
        return 1 === arguments.length ? function() {
        ...
        },messages: {required: "不能为空.",remote: "Please fix this field.",email: "请输入一个有效的邮箱地址.",url: "请输入一个有效的网址.",date: "请输入一个有效的日期.",dateISO: "Please enter a valid date ( ISO ).",number: "请输入有效数字.",digits: "请输入一个整数.",creditcard: "Please enter a valid credit card number.",equalTo: "Please enter the same value again.",maxlength: a.validator.format("最多只能输入 {0} 字符."),minlength: a.validator.format("至少输入 {0} 字符."),rangelength: a.validator.format("字符数限制在 {0} 和 {1} 之间."),range: a.validator.format("请输入一个置于 {0} 到 {1} 之间的数字."),max: a.validator.format("请输入一个大于 {0} 的数字."),min: a.validator.format("请输入一个小于 {0} 的数字."),pattern: a.validator.format("验证格式错误."),nonzero: a.validator.format(""),zipcode: a.validator.format("邮政编码格式错误."),mobile: a.validator.format("手机号码错误."),tel: a.validator.format("电话号码错误."),idcard: a.validator.format("身份证验证失败.")},autoCreateRanges: !1,prototype: {init: function() {
                function b(b) {
            ...
            a.validator.methods[b] = c, a.validator.messages[b] = void 0 !== d ? d : a.validator.messages[b], c.length < 3 && a.validator.addClassRules(b, a.validator.normalizeRule(b))
			...
			},nonzero: function(a, b, c) {
				return this.optional(b) || parseInt(a)>0;
			},zipcode: function(a, b, c) {
				return this.optional(b) || /^\d{6}$/.test(a)
			},mobile: function(a, b, c) {
				return this.optional(b) || /^1[3|4|5|6|7|8|9]\d{9}$/.test(a)
			},tel: function(a, b, c) {
				return this.optional(b) || /^([0-9]{3,4}-)?[0-9]{7,8}$/.test(a)
			},idcard: function(a, b, c) {
				 var len = a.length, re=/^((1[1-5])|(2[1-3])|(3[1-7])|(4[1-6])|(5[0-4])|(6[1-5])|71|(8[12])|91)\d{4}((19\d{2}(0[13-9]|1[012])(0[1-9]|[12]\d|30))|(19\d{2}(0[13578]|1[02])31)|(19\d{2}02(0[1-9]|1\d|2[0-8]))|(19([13579][26]|[2468][048]|0[48])0229))\d{3}(\d|X|x)?$/,isCnNewID=function(cid){  
				...
				return (a.match(re)!=null && isCnNewID(a)) ? true : false;
