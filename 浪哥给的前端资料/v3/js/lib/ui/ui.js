/* jdf-1.0.0/ ui.js Date:2015-12-22 16:24:57 */
"undefined" == typeof $.ui && ($.ui = {}),
    ...
    function (a) {
        ...
        } : (a.browser.webkit || (a.browser.webkit = /webkit/.test(c)), a.browser.mozilla && (a.browser.msie = /trident/.test(c))), a.extend(a.browser, function () {
            {
